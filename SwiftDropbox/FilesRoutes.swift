...
open class FilesRoutes {
    ...
    */
    open func getMetadata(path: String, includeMediaInfo: Bool = false) -> BabelRpcRequest<Files.MetadataSerializer, Files.GetMetadataErrorSerializer> {
    ...
    */
    open func listFolderLongpoll(cursor: String, timeout: UInt64 = 30) -> BabelRpcRequest<Files.ListFolderLongpollResultSerializer, Files.ListFolderLongpollErrorSerializer> {
    ...
    */
    open func listFolder(path: String, recursive: Bool = false, includeMediaInfo: Bool = false, includeDeleted: Bool = false) -> BabelRpcRequest<Files.ListFolderResultSerializer, Files.ListFolderErrorSerializer> {
    ...
    */
    open func listFolderContinue(cursor: String) -> BabelRpcRequest<Files.ListFolderResultSerializer, Files.ListFolderContinueErrorSerializer> {
    ...
    */
    open func listFolderGetLatestCursor(path: String, recursive: Bool = false, includeMediaInfo: Bool = false, includeDeleted: Bool = false) -> BabelRpcRequest<Files.ListFolderGetLatestCursorResultSerializer, Files.ListFolderErrorSerializer> {
        let request = Files.ListFolderArg(path: path, recursive: recursive, includeMediaInfo: includeMediaInfo, includeDeleted: includeDeleted)
    ...
    */
    open func download(path: String, rev: String? = nil, destination: (URL, HTTPURLResponse) -> URL) -> BabelDownloadRequest<Files.FileMetadataSerializer, Files.DownloadErrorSerializer> {
    ...
    */
    open func uploadSessionStart(body: Data) -> BabelUploadRequest<Files.UploadSessionStartResultSerializer, VoidSerializer> {
    ...
    /**
        ...
        success or a `Void` object on failure.
    */
    open func uploadSessionStart(body: URL) -> BabelUploadRequest<Files.UploadSessionStartResultSerializer, VoidSerializer> {
    ...
    /**
        ...
        success or a `Void` object on failure.
    */
    open func uploadSessionStart(body: InputStream) -> BabelUploadRequest<Files.UploadSessionStartResultSerializer, VoidSerializer> {
    ...
    */
    open func uploadSessionAppend(sessionId: String, offset: UInt64, body: Data) -> BabelUploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
    ...
    /**
        ...
        `Files.UploadSessionLookupError` object on failure.
    */
    open func uploadSessionAppend(sessionId: String, offset: UInt64, body: URL) -> BabelUploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let request = Files.UploadSessionCursor(sessionId: sessionId, offset: offset)
    ...
    /**
        ...
        `Files.UploadSessionLookupError` object on failure.
    */
    open func uploadSessionAppend(sessionId: String, offset: UInt64, body: InputStream) -> BabelUploadRequest<VoidSerializer, Files.UploadSessionLookupErrorSerializer> {
        let request = Files.UploadSessionCursor(sessionId: sessionId, offset: offset)
    ...
    */
    open func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, body: Data) -> BabelUploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
    ...
    /**
        ...
        `Files.UploadSessionFinishError` object on failure.
    */
    open func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, body: URL) -> BabelUploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
        let request = Files.UploadSessionFinishArg(cursor: cursor, commit: commit)
    ...
    /**
        ...
        `Files.UploadSessionFinishError` object on failure.
    */
    open func uploadSessionFinish(cursor: Files.UploadSessionCursor, commit: Files.CommitInfo, body: InputStream) -> BabelUploadRequest<Files.FileMetadataSerializer, Files.UploadSessionFinishErrorSerializer> {
        let request = Files.UploadSessionFinishArg(cursor: cursor, commit: commit)
    ...
    */
    open func upload(path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, body: Data) -> BabelUploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
    ...
    /**
        ...
        `Files.UploadError` object on failure.
    */
    open func upload(path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, body: URL) -> BabelUploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
        let request = Files.CommitInfo(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute)
    ...
    /**
        ...
        `Files.UploadError` object on failure.
    */
    open func upload(path: String, mode: Files.WriteMode = .add, autorename: Bool = false, clientModified: Date? = nil, mute: Bool = false, body: InputStream) -> BabelUploadRequest<Files.FileMetadataSerializer, Files.UploadErrorSerializer> {
        let request = Files.CommitInfo(path: path, mode: mode, autorename: autorename, clientModified: clientModified, mute: mute)
    ...
    */
    open func search(path: String, query: String, start: UInt64 = 0, maxResults: UInt64 = 100, mode: Files.SearchMode = .filename) -> BabelRpcRequest<Files.SearchResultSerializer, Files.SearchErrorSerializer> {
    ...
    */
    open func createFolder(path: String) -> BabelRpcRequest<Files.FolderMetadataSerializer, Files.CreateFolderErrorSerializer> {
    ...
    */
    open func delete(path: String) -> BabelRpcRequest<Files.MetadataSerializer, Files.DeleteErrorSerializer> {
    ...
    /**
        ...
        `Files.DeleteError` object on failure.
    */
    open func permanentlyDelete(path: String) -> BabelRpcRequest<VoidSerializer, Files.DeleteErrorSerializer> {
        let request = Files.DeleteArg(path: path)
    ...
    */
    open func copy(fromPath: String, toPath: String) -> BabelRpcRequest<Files.MetadataSerializer, Files.RelocationErrorSerializer> {
    ...
    /**
        ...
        `Files.RelocationError` object on failure.
    */
    open func move(fromPath: String, toPath: String) -> BabelRpcRequest<Files.MetadataSerializer, Files.RelocationErrorSerializer> {
        let request = Files.RelocationArg(fromPath: fromPath, toPath: toPath)
    ...
    */
    open func getThumbnail(path: String, format: Files.ThumbnailFormat = .jpeg, size: Files.ThumbnailSize = .w64h64, destination: (URL, HTTPURLResponse) -> URL) -> BabelDownloadRequest<Files.FileMetadataSerializer, Files.ThumbnailErrorSerializer> {
    ...
    */
    open func getPreview(path: String, rev: String? = nil, destination: (URL, HTTPURLResponse) -> URL) -> BabelDownloadRequest<Files.FileMetadataSerializer, Files.PreviewErrorSerializer> {
    ...
    */
    open func listRevisions(path: String, limit: UInt64 = 10) -> BabelRpcRequest<Files.ListRevisionsResultSerializer, Files.ListRevisionsErrorSerializer> {
    ...
    */
    open func restore(path: String, rev: String) -> BabelRpcRequest<Files.FileMetadataSerializer, Files.RestoreErrorSerializer> {
